...
ALTER TABLE `library_media` ADD CONSTRAINT `fk_library_media_media_types` FOREIGN KEY (`media_type`) REFERENCES `media_types`(`id`) ON UPDATE NO ACTION ON DELETE NO ACTION;

INSERT INTO db_version (db_version_id, file_name, jira_issue)
VALUES (6, '005-create-library-media-table.sql', 'RS-5');